...
export declare function generateHtmlReport(diffResults: DiffResult[]): string | undefined;
...
export declare function reportToArtifact(resultDir: string, html: string): Promise<void>;
